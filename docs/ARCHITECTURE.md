...
flowchart TD
  ...
  API -. optional .-> FreeLLM["Self-hosted FreeLLMAPI"]
...
| AI search planning | `app/lib/radar-ai.ts` | Optional FreeLLMAPI query planning with validated output and local fallback |
